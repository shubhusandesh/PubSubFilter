...
({
    ...
    /***/
    "./src/components/FurFilterList.js":
        /*!*****************************************!*\
          !*** ./src/components/FurFilterList.js ***!
          \*****************************************/
    ...
    "./src/index.js":
        ...
        (function (module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _store_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./store/index.js */ \"./src/store/index.js\");\n/* harmony import */ var _components_FurPicker_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/FurPicker.js */ \"./src/components/FurPicker.js\");\n/* harmony import */ var _components_FurFilterList_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/FurFilterList.js */ \"./src/components/FurFilterList.js\");\n/* harmony import */ var _components_FurSortFilter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/FurSortFilter.js */ \"./src/components/FurSortFilter.js\");\n/* harmony import */ var _components_ProductsList_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/ProductsList.js */ \"./src/components/ProductsList.js\");\n\r\n\r\n// Load up components\r\n\r\n\r\n\r\n\r\n\r\n\r\nObject.assign(window, {\r\n    FurPicker: _components_FurPicker_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\r\n    FurFilterList: _components_FurFilterList_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"],\r\n    FurSortFilter: _components_FurSortFilter_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"],\r\n    ProductsList: _components_ProductsList_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"]\r\n})\n\n//# sourceURL=webpack:///./src/index.js?");
...
$(document).ready(function () {
    const perPriceFilter = new window.FurPicker(".perPriceFilter", {
    ...
    const FurPickerI = new window.FurPicker(".designTypeFilter", {
        label: "Type / Design",
        group: true,
        width: 350,
        data: [{
    ...
    const FurPickerII = new window.FurPicker(".materialFilter", {
        label: "Material",
        type: "imageBox",
        width: 350,
        data: [{
    ...
    const sizeFilter = new window.FurPicker(".sizeFilter", {
        label: "Color",
        type: "checkbox",
        data: [{
                label: "Gray"
    ...
    const furSortFilter = new window.FurSortFilter(".furSortFilter", {
        label: "SortFilter",
        group: true,
        width: 350,
        buttonWidth: 150,
    ...
    const FurFilterListI = new window.FurFilterList(".listFilters", {});

    const ProductsListI = new window.ProductsList(".productsList", {});
})
...
(function (factory) {
    ...
    $.fn.smartmenus.defaults = {
        ...
        collapsibleBehavior: false // parent items behavior in collapsible (mobile) view ('default', 'toggle', 'link', 'accordion', 'accordion-toggle', 'accordion-link')
...
(function() {
  ...
  $.fn.stick_in_parent = function(opts) {
    ...
    $(window).on('load', function() {
        window.onscroll = function(e) {stickyNavBar(e)};
        // var navbar = $('.m-fur_header');
        let navbar = $('.m-fur_header-sticky');
        ...
        function stickyNavBar(e) {
            ...
            if (currentScroll > lastScroll && !navbar.hasClass('scroll-down')) {
              // down
              navbar.removeClass("sticky").removeClass("scroll-up").addClass("scroll-down");
            } else if (currentScroll < lastScroll && navbar.hasClass('scroll-down')) {
              // up
              navbar.addClass("sticky").addClass("scroll-up").removeClass("scroll-down");
            }
